...
extension CompanyByIndex on IsarCollection<Company> {
  ...
  Future<List<Company?>> getAllById(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
    return getAllByIndex(r'id', values);
  }

  List<Company?> getAllByIdSync(List<String> idValues) {
    final values = idValues.map((e) => [e]).toList();
  ...
  Future<Id> putById(Company object) {
    return putByIndex(r'id', object);
  }

  Id putByIdSync(Company object, {bool saveLinks = true}) {
    return putByIndexSync(r'id', object, saveLinks: saveLinks);
  }

  Future<List<Id>> putAllById(List<Company> objects) {
    return putAllByIndex(r'id', objects);
  }

  List<Id> putAllByIdSync(List<Company> objects, {bool saveLinks = true}) {
...
extension CompanyQueryWhere on QueryBuilder<Company, Company, QWhereClause> {
  ...
  QueryBuilder<Company, Company, QAfterWhereClause> idEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Company, Company, QAfterWhereClause> idNotEqualTo(String id) {
    return QueryBuilder.apply(this, (query) {
      if (query.whereSort == Sort.asc) {
        return query
...
extension CompanyQueryFilter
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> isDeletedEqualTo(
      bool value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugEqualTo(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugContains(
      String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.contains(
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugMatches(
      String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.matches(
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'slug',
        value: '',
  ...
  QueryBuilder<Company, Company, QAfterFilterCondition> slugIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'slug',
        value: '',
...
extension CompanyQuerySortBy on QueryBuilder<Company, Company, QSortBy> {
  ...
  QueryBuilder<Company, Company, QAfterSortBy> sortByIsDeleted() {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Company, Company, QAfterSortBy> sortBySlug() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'slug', Sort.asc);
    });
  }

  QueryBuilder<Company, Company, QAfterSortBy> sortBySlugDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension CompanyQuerySortThenBy
  ...
  QueryBuilder<Company, Company, QAfterSortBy> thenByIsDeleted() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'isDeleted', Sort.asc);
    });
  }
  ...
  QueryBuilder<Company, Company, QAfterSortBy> thenBySlug() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'slug', Sort.asc);
    });
  }

  QueryBuilder<Company, Company, QAfterSortBy> thenBySlugDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'slug', Sort.desc);
    });
  }
...
extension CompanyQueryWhereDistinct
  ...
  QueryBuilder<Company, Company, QDistinct> distinctBySlug(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension CompanyQueryProperty
  ...
  QueryBuilder<Company, String, QQueryOperations> slugProperty() {
    return QueryBuilder.apply(this, (query) {
...
CompanyCreateLocal _$CompanyCreateLocalFromJson(Map<String, dynamic> json) =>
    CompanyCreateLocal(
...
Map<String, dynamic> _$CompanyCreateLocalToJson(CompanyCreateLocal instance) =>
    <String, dynamic>{
...
Map<String, dynamic> _$CompanyUpdateLocalToJson(CompanyUpdateLocal instance) {
